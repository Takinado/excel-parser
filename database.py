...
class Database:
    ...
    def __init__(self, connect_string: str = "excel_parser.db") -> None:
    ...
    def save(self, data: list[tuple]) -> None:
        ...
        query_string = (
            f"INSERT INTO {self.TABLE_NAME} ('value', 'date', 'data_type', 'company', 'timing') VALUES "
            + ", ".join(query)
            + ";"
        )
